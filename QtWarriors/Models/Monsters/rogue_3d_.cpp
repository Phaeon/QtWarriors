...
Rogue_3D_::Rogue_3D_(const int &x, const int &y, const int &z,
    ...
    : PawnGL (x, y, z, dir, angle_x, angle_y, angle_z, good), angle_pattes(0.0f), translation_attaque_rogue(0.0f)
{}
...
GLvoid Rogue_3D_::attack()
{
    if (isAttacking())
    {
        ...
        if (translation_attaque_rogue >= 20.0f) {
            translation_attaque_rogue = 0.0f;
            attacking();
        }
    }
}
...
GLvoid Rogue_3D_::s_attack()
{
    if (isAttacking())
    {
        glPushMatrix();
        {
            glutSolidTorus(0.4 + translation_attaque_rogue, 0.4 + translation_attaque_rogue, 20, 20);
            translation_attaque_rogue += 0.3f;
        }
        glPopMatrix();
