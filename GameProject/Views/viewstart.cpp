...
void ViewStart::about(){
    ...
    msg->setText(tr("This application was created by JOUVIN Tanguy, HOGG Jack and GRENON Guillaume for a stage of L3 computer"));
...
void ViewStart::help(){
    ...
    msg->setText(tr("Rules are not yet specified"));
    QAbstractButton* pButtonYes = msg->addButton(tr("yes"), QMessageBox::YesRole);
    pButtonYes->setStyleSheet("background-color: #4CD80F;");
    pButtonYes->setFont(QFont("Bradley Hand ITC", 13));
    msg->adjustSize();
